               ...
               <CardContent>
                    ...
                    <Box pt={7} pb={1}>
                         <Slider
                              ...
                              disabled={disabled}
                         />
                         <Typography id="discrete-slider" align="left" variant="subtitle2" color="textSecondary">Amount of ETH to deposit</Typography>
                    </Box>
               </CardContent>

               <CardActions>
                    <Button variant="contained" fullWidth onClick={() => { props.config.function(value) }} disabled={disabled} color="secondary">Deposit Funds</Button>
               </CardActions>
          </Box>
     );
